...
public class Favourites extends ListActivity implements TextWatcher {
	...
	public void onCreate(Bundle savedInstanceState){
		...
		Bus.tracker.trackPageView("/Favourites");
        ...
        queryField.setBackgroundResource(R.color.favourite_background);
        Color black = new Color();
        queryField.setTextColor(Color.WHITE);
        ...
        clearAnswerButton.setVisibility(View.GONE);
...
//        	returnText = SendQuery.sendQueryJsoup(query);
		...
		protected void onProgressUpdate(Void...voids){
        	dialog = ProgressDialog.show(Favourites.this, "", getString(R.string.sending_query), true);
        }
